...
public class EadoreBiomeFeatures extends DefaultBiomeFeatures
{
    ...
    public static void addEadoreOres(Biome biomeIn) // Replace with Eadore variation once they are implemented
    {
        ...
        biomeIn.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, Feature.ORE.withConfiguration(new OreFeatureConfig(EADORE_NATURAL_STONE, EADORE_GOLD_ORE, 9)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(2, 0, 0, 32))));
